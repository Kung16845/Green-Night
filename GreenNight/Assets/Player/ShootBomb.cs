    ...
    void Update()
    {
        ...
        if (Input.GetKeyUp(KeyCode.G) && hasPressedG)
        {
            ...
            if (currentChargeTime < minimumhargeTime)
            {
                ...
                ShootBombServerRpc(groundDispenseVelocity * minimumhargeTime, verticalDispenseVelocity * minimumhargeTime);
            }
            else
            {
                ...
                {
                    ShootBombServerRpc(groundDispenseVelocity * currentChargeTime, verticalDispenseVelocity * currentChargeTime);
                }
                else
                {
                    ShootBombServerRpc(groundDispenseVelocity * maxChargeTime, verticalDispenseVelocity * maxChargeTime);
                }
            }
